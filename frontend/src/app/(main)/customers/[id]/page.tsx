  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Kundeinformasjonen ble lagret.",
      })
      ...
      toast({
        title: "Feil",
        description: "Kunne ikke oppdatere kunde. Prøv igjen.",
        variant: "destructive",
      })
    }
  }
      ...
      <div className="space-y-6">
        ...
        <Card className="border-red-200">
          <CardHeader>
            ...
            <CardDescription>
              Kunne ikke finne kunden med ID {customerId}
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight">{formData.kundenavn}</h1>
              <div className="flex items-center gap-4 mt-2">
                <Badge variant={formData.kundeinaktiv ? "destructive" : "default"}>
                  {formData.kundeinaktiv ? "Inaktiv" : "Aktiv"}
                </Badge>
                {formData.kundeid && (
                  <span className="text-sm text-gray-500 flex items-center gap-1">
                    <Hash className="h-3 w-3" />
                    Kunde ID: {formData.kundeid}
                  </span>
                )}
              </div>
            </div>
